...
namespace raion.Controllers
{
    ...
    public class MoreDataController : Controller
    {
        private readonly IDataAccessService _dataAccessService;
        public MoreDataController(IDataAccessService dataAccessService)
        {
            _dataAccessService = dataAccessService;
        }
    
        [HttpGet("savedata")]
        public async Task<object> SaveData([FromQuery] string text)
        {
            try
            {
